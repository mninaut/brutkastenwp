...
define ('DIRECTORY_CACHE', '../../cache/images');		// cache directory
define ('MAX_WIDTH', 21500);					// maximum image width
define ('MAX_HEIGHT', 21500);				// maximum image height
define ('ALLOW_EXTERNAL', FALSE);			// allow external website (override security precaution - not advised!)
define ('MEMORY_LIMIT', '200M');				// set PHP memory limit
define ('MAX_FILE_SIZE', 25000000);			// file size limit to prevent possible DOS attacks (roughly 1.5 megabytes)
